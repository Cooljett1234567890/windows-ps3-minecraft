...
wstring Language::getElement(const wstring& elementId, ...)
{
#if defined(__PSVITA__) || defined(_WIN64)		// 4J - vita doesn't like having a reference type as the last parameter passed to va_start - we shouldn't need this method anyway
	return L"";
#else
	va_list args;
